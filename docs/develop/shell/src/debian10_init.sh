...
# https://cdimage.debian.org/cdimage/unofficial/non-free/cd-including-firmware/archive/10.8.0+nonfree/amd64/iso-dvd/firmware-10.8.0-amd64-DVD-1.iso
...
'''
echo "${software_list}" |xargs -n 5 apt-get install -y
unset software_list
